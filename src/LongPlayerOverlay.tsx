...
const DynamicCaptions: React.FC<{ text: string, isActive: boolean }> = ({ text, isActive }) => {
    ...
    // Pure text colors for Neon effect
    const colors = [
        'text-red-500',
        'text-cyan-400',
        'text-yellow-400',
    ...
    return (
      <div className="absolute bottom-20 left-1/2 -translate-x-1/2 z-[100] w-full max-w-[90%] pointer-events-none flex flex-col items-center justify-center text-center">
        <div 
